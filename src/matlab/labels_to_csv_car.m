clear; clc; close all;
%%
load(['G:\Documents\Pycharm Projects\Work_Package_1\data\lidar_data\CAR\Scenario-3\car_cepton_overlap_1\person_1\out\session_labels_csv\' ...
    'id-755_id-904_fixed_person_1_labels.mat'])
%%
allLabels = {};
